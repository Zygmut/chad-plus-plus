...
public class FileData {
    ...
    public boolean checkFileData() {
        ...
        ErrorHandler.addError(ErrorCodes.ARGUMENT_INVALID_FILE_EXTENSION, -1, Env.PRE_COMPILER_PHASE);
    ...
    public void setMultipleFileData(String filePath, String outputPath) {
        ...
        try {
            ...
            ErrorHandler.addError(ErrorCodes.ARGUMENT_INVALID_FILE, -1, Env.PRE_COMPILER_PHASE);
            this.fileName = "";
        }
        try {
            this.fileExtension = substring.split("[.]")[1];
